(function() {
  ...
  var itemSideSize;
  var diceIconHtml =
    "<i class='dh-icon dh-icon-dice'>🎲<svg><use xlink:href='#dh-dice'/></svg></i>";
  var saveIconHtml =
    "<i class='dh-icon dh-icon-dice'>💾<svg><use xlink:href='#dh-save'/></svg></i>";
  var okayIconHtml =
    "<i class='dh-icon dh-icon-okay'>👌<svg><use xlink:href='#dh-okay'/></svg></i>";
  var crownIconHtml =
    "<i class='dh-icon dh-icon-crown'>👑<svg><use xlink:href='#dh-crown'/></svg></i>";
  ...
  var initDom = function(dom) {
    ...
    var btn = $(
      "\
      <div class='actions'>\
        <a class='button primary' id='dh-history-show'>" +
        saveIconHtml +
        "</a>\
        <a class='button primary' id='dh-lottery-go'>" +
        diceIconHtml +
        "</a>\
      </div>\
    "
  ...
  var appendNewUserToList = function(item) {
    var html =
      ...
      (function() {
        if (item.avatar) {
          return `<div class="avatar"><span class="image avatar-image is-64x64"><img src="${
            item.avatar
          }" alt="avatar" /></span></div`;
        } else {
          return `<div class="avatar"><span class="image dh-name-avatar avatar-image is-64x64">${item
  ...
  var stopLottery = function() {
    ...
    for (var i = 0; i < currentTarget.length; i++) {
      var winnerProfile = JSON.parse(
        decodeURIComponent($($(".profile")[currentTarget[i]]).data("profile"))
      );
  ...
  var startLottery = function() {
    ...
    if (
      settings.once &&
      settings.data.length - arrayCount(settings.winnerList) < settings.number
    ) {
  ...
  var showHistory = function() {
    ...
    var tplUser = function(data) {
      ...
      <div>
        ...
        (function() {
          if (data.avatar) {
            return `<div class="avatar"><span class="image avatar-image is-10x10"><img src="${
              data.avatar
            }" alt="avatar" /></span></div`;
          } else {
            return `<div class="avatar"><span class="image dh-name-avatar avatar-image is-10x10">${data
